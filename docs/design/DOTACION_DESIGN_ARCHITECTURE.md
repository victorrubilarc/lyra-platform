...
| **S3** | Acreditación de contratistas: **gate** por `accreditationStatus`/`accreditedUntil` (empresa) + avisos; UI de acreditación. | Prequalification empresa (ISN/Avetta/Veriforce, Ley 16.744 66bis/183-C). |
